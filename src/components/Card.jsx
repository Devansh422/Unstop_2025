...
function Card() {
    ...
    const items = [
        { 
            title: "Innovate with UNSTOP", 
            description: "Push the boundaries of technology and turn your innovative ideas into reality. Join us in creating the future through groundbreaking projects and initiatives that redefine what's possible.",
        ...
        { 
            title: "Learn with UNSTOP", 
            description: "Gain hands-on experience with cutting-edge technology through our workshops and talks led by industry experts. Grow your skills and knowledge in a supportive environment that fosters continuous learning.",
            image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        { 
            title: "Collaborate with UNSTOP", 
            description: "Work on exciting projects with fellow innovators and share ideas in a collaborative community. Learn from each other and build a supportive network that values diverse perspectives and teamwork.",
            image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        { 
            title: "Inspire with UNSTOP", 
            description: "Be a part of something bigger and make a meaningful impact with your work. Inspire others to join the journey and contribute to a future where innovation knows no bounds.",
            image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
