...
gsap.registerPlugin(ScrollTrigger);
 ...
 function Capsule() {
  ...
  return (
    <div id="contact" data-color="white" ref={container} className="capsules  section w-full sm:h-[115vh] 
    ...
    >
        <div className="left sm:w-1/3 h-full flex flex-col sm:justify-between py-10 items-start " >
            ...
            Follow UNSTOP: Stay Plugged into Tech's Pulse!
            <br></br>
            <a href="#"><b>@unstopigniters_abesec</b></a>
            </h1>
            <div className="heading">
                <h1 className="font-[SansitaReg] text-[5vh] leading-[6.5vh] sm:text-[8vh] py-5 sm:leading-[9vh]">Explore <br/> Our Insights</h1>
                <Button bgColor="bg-[#f5f19c]" text="VIEW INSTAGRAM PAGE" />
            </div>
        </div>
        <div className=" right font-[SansitaReg] mt-10 sm:w-2/3 space-y-10 h-full sm:flex items-start justify-start sm:gap-20  ">
            ...
            <div   
                ...
                <div className="text text-center font-[Sansita] text-[6vw] sm:text-[3vh] font-semibold mt-10 leading-[4.8vh]">
                    <h3>UNSTOP organizes tech<br/> workshops, hackathons,<br/> and talks, fostering <br/>innovation and learning <br/>across campus.
                    </h3>
                </div>
            ...
            >
                ...
                <div className="text text-center font-[Sansita] text-[2.5vh] flex flex-col gap-6 mb-6 font-semibold leading-[4.8vh]">
                    <h3>UNSTOP connects students <br />with valuable internships,<br /> bridging the gap between <br /> academics and industry<br /> experience.
                    </h3>
                </div>
                <div className="image w-[74vw] h-[74vw] sm:w-[40vh] sm:h-[40vh]  rounded-full overflow-hidden">
